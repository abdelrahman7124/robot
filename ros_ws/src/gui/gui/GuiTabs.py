...
class UI(QMainWindow):
    def __init__(self):
        ...
        self.Task1PushBt_AddPath.clicked.connect(Publisher("add_path").sender("ADD_path"))

        self.Task1PushBt_Start = self.findChild(QPushButton, "Start_lable")  
        self.Task1PushBt_Start.clicked.connect(Publisher("start_lable").sender("Start"))

        self.Task1PushBt_Finish = self.findChild(QPushButton, "Finish_lable_2")  
        self.Task1PushBt_Finish.clicked.connect(Publisher("finish_lable").sender("Finish"))        
        
        #Control Buttons
        self.MovePushBt_Forward= self.findChild(QPushButton, "Forward_PushB")  
        self.MovePushBt_Forward.clicked.connect(Publisher("motor_direction").sender("Forward"))
        
        self.MovePushBt_L_Forward = self.findChild(QPushButton, "l_froward_PushB")  
        self.MovePushBt_L_Forward.clicked.connect(Publisher("motor_direction").sender("L_Forward"))

        self.MovePushBt_R_Forward = self.findChild(QPushButton, "R_Forward_PushB")
        self.MovePushBt_R_Forward.clicked.connect(Publisher("motor_direction").sender("R_Forward"))  

        self.MovePushBt_Left = self.findChild(QPushButton, "Left_PushB")
        self.MovePushBt_Left.clicked.connect(Publisher("motor_direction").sender("Left"))  

        self.MovePushBt_Right = self.findChild(QPushButton, "Right_PushB")
        self.MovePushBt_Right.clicked.connect(Publisher("motor_direction").sender("Right"))  

        self.MovePushBt_L_back = self.findChild(QPushButton, "L_Back_PushB")
        self.MovePushBt_L_back.clicked.connect(Publisher("motor_direction").sender("L_Back"))  

        self.MovePushBt_Back= self.findChild(QPushButton, "Back_PushB")
        self.MovePushBt_Back.clicked.connect(Publisher("motor_direction").sender("Back"))  

        self.MovePushBt_R_back = self.findChild(QPushButton, "R_Back_PushB")
        self.MovePushBt_R_back.clicked.connect(Publisher("motor_direction").sender("R_Back"))  
#h
        self.MovePushBt_STOP = self.findChild(QPushButton, "STOP_PushB")  
        self.MovePushBt_STOP.clicked.connect(Publisher("motor_direction").sender("STOP"))
